...
# Define o diretório onde as imagens com rostos detectados serão armazenada
output_directory = "detected_faces" # Cria o diretório, se ele não existir

os.makedirs(output_directory, exist_ok=True) #Loop para captura e detecção de rostos
while True:
    ...
    for(x, y, w, h) in faces: 
        ...
        cv2.rectangle(im, (x, y), (x + w, y + h), (65, 159, 96))
